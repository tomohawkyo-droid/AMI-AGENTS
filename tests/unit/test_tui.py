...
class TestVisibleLen:
    """Tests for _visible_len function."""

    def test_plain_text(self) -> None:
        """Test length of plain text."""
        assert _visible_len("hello") == EXPECTED_PLAIN_TEXT_LEN

    def test_strips_ansi_codes(self) -> None:
        """Test strips ANSI escape codes."""
        colored = f"{Colors.RED}hello{Colors.RESET}"
        assert _visible_len(colored) == EXPECTED_ANSI_STRIPPED_LEN
    ...
    def test_multiple_colors(self) -> None:
        ...
        assert _visible_len(text) == EXPECTED_MULTI_COLOR_LEN  # "redgreen"
