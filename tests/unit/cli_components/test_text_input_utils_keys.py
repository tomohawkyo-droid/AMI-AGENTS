...
class TestHandleCtrlArrowSequenceAfterSemicolon:
    ...
    def test_not_five_returns_not_handled(self, mock_get_char):
        """Test non-5 modifier returns None."""
        mock_get_char.return_value = ("X", ord("X"))
    ...
    def test_unknown_direction_returns_not_handled(self, mock_get_char):
        """Test unknown direction returns None."""
...
class TestHandleControlCharacters:
    ...
    def test_ctrl_s_returns_submit(self):
        """Test Ctrl+S returns SUBMIT."""
    ...
    def test_enter_lf(self):
        """Test Enter (LF) returns ALT_ENTER."""
...
class TestReadKeySequence:
    ...
    @patch("ami.cli_components.text_input_utils.get_char_with_ordinals")
    def test_escape_sequence_handled(self, mock_get_char, mock_stdin_data):
    ...
    @patch("ami.cli_components.text_input_utils._stdin_has_data", return_value=True)
    @patch("ami.cli_components.text_input_utils.get_char_with_ordinals")
    def test_escape_not_handled_returns_esc_char(self, mock_get_char, mock_stdin_data):
    ...
    @patch("ami.cli_components.text_input_utils.get_char_with_ordinals")
    def test_bare_escape_returns_esc_string(self, mock_get_char, mock_stdin_data):
        """Test bare ESC key returns 'ESC' string for dialog cancellation."""
        mock_get_char.return_value = ("\x1b", ESC)
