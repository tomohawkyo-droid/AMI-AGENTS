...
class TestGetcharMocked:
    ...
    @patch("ami.cli_components.text_input_utils.os.read", return_value=b"a")
    ...
    def test_getchar_returns_character(
        self, mock_stdin, mock_tty, mock_termios, mock_os_read
    ):
    ...
    @patch("ami.cli_components.text_input_utils.os.read", return_value=b"x")
    @patch("ami.cli_components.text_input_utils.termios")
    @patch("ami.cli_components.text_input_utils.tty")
    @patch("ami.cli_components.text_input_utils.sys.stdin")
    def test_getchar_restores_settings(
        self, mock_stdin, mock_tty, mock_termios, mock_os_read
    ):
...
class TestHandleEscapeSequence:
    ...
    @patch("ami.cli_components.text_input_utils._stdin_has_data", return_value=True)
    @patch("ami.cli_components.text_input_utils.get_char_with_ordinals")
    def test_handles_bracket_ansi(self, mock_get_char, mock_stdin_data):
    ...
    @patch("ami.cli_components.text_input_utils._stdin_has_data", return_value=True)
    @patch("ami.cli_components.text_input_utils.get_char_with_ordinals")
    def test_handles_osc_prefix(self, mock_get_char, mock_stdin_data):
    ...
    @patch("ami.cli_components.text_input_utils._stdin_has_data", return_value=True)
    @patch("ami.cli_components.text_input_utils.get_char_with_ordinals")
    def test_handles_alt_enter(self, mock_get_char, mock_stdin_data):
    ...
    @patch("ami.cli_components.text_input_utils._stdin_has_data", return_value=True)
    @patch("ami.cli_components.text_input_utils.get_char_with_ordinals")
    def test_handles_alt_enter_lf(self, mock_get_char, mock_stdin_data):
    ...
    @patch("ami.cli_components.text_input_utils._stdin_has_data", return_value=True)
    @patch("ami.cli_components.text_input_utils.get_char_with_ordinals")
    def test_unrecognized_returns_not_handled(self, mock_get_char, mock_stdin_data):
        """Test unrecognized sequence returns None."""
    ...
    @patch("ami.cli_components.text_input_utils._stdin_has_data", return_value=False)
    def test_bare_esc_returns_esc_string(self, mock_stdin_data):
        """Test bare ESC (no following bytes) returns 'ESC' string."""
        result = _handle_escape_sequence()
...
class TestCheckPasteSequences:
    ...
    def test_not_paste_returns_not_handled(self):
        """Test non-paste character returns None."""
...
class TestCheckBracketedPasteSequence:
    ...
    def test_not_paste_returns_not_handled(self, mock_get_char):
        """Test non-paste sequence returns None."""
