...
from ami.cli_components.tui import TUI, _format_box_row, visible_len
...
class TestTUIVisibleLen:
    """Test visible_len utility."""

    def test_plain_text(self):
        assert visible_len("hello") == EXPECTED_HELLO_LEN

    def test_with_ansi(self):
        assert visible_len("\033[31mred\033[0m") == EXPECTED_RED_ANSI_LEN

    def test_empty(self):
        assert visible_len("") == EXPECTED_EMPTY_LEN
