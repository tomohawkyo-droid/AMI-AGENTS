...
**Commit-msg (2 checks)**: `check-commit-message` (format validation), `block-coauthored` (block co-authored-by lines)

**Pre-push (2 checks)**: `block-coauthored-history` (full history scan), `verify-coverage` (unit >90%, integration >75%)
